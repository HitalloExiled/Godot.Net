...
{
    [Flags]
    public enum PIXEL_FORMAT_DESCRIPTOR_FLAGS : uint
    {
        /// <summary>
        ...
        /// For such systems to use hardware acceleration, the hardware palette must be in a fixed order (for example, 3-3-2) when in RGBA mode or must match the logical palette when in color-index mode.
