// <auto-generated/>
#if    !CANVAS_SHADER_GLES3_GLES
#define CANVAS_SHADER_GLES3_GLES
...
namespace Godot.Net.Drivers.GLES3.Shaders
{
    ...
    public class CanvasShaderGLES3 : ShaderGLES3
    {
        ...
        protected override void Init()
        {
            ...
            var texunitPairs = new TexUnitPair[]
            {
                new("atlas_texture", -2),
                new("shadow_atlas_texture", -3),
                new("color_buffer", -4),
                new("sdf_texture", -5),
                new("normal_texture", -6),
                new("specular_texture", -7),
                new("color_texture", 0),
            };

            var uboPairs = new UBOPair[]
            {
                new("MaterialUniforms", 4),
                new("GlobalShaderUniformData", 1),
                new("CanvasData", 0),
                new("LightData", 2),
            };
            ...
            var specPairs = new Specialization[]
            {
                ...
                new("USE_RGBA_SHADOWS", false),
                new("SINGLE_INSTANCE", false),
            };
